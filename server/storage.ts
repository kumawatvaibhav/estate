...
export class MemStorage implements IStorage {
  ...
  private seedData(): void {
    ...
    // Add sample cities
    // Add sample cities with working image URLs
    const bombay = this.createCity({
      name: 'Bombay',
      state: 'Maharashtra',
      property_count: 12450,
      image_url: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2835&q=80'
    });
    ...
    const delhi = this.createCity({
      ...
      image_url: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80'
    });
    ...
    const bangalore = this.createCity({
      ...
      state: 'Karnataka',
      property_count: 9870,
      image_url: 'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2942&q=80'
    });
    ...
    const hyderabad = this.createCity({
      ...
      state: 'Telangana',
      property_count: 7630,
      image_url: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80'
    });
    ...
    const pune = this.createCity({
      ...
      state: 'Maharashtra',
      property_count: 6920,
      image_url: 'https://images.unsplash.com/photo-1605640840605-14ac1855827b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2942&q=80'
    });
    ...
    const chennai = this.createCity({
      ...
      state: 'Tamil Nadu',
      property_count: 5480,
      image_url: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80'
    });
